...
import com.mld46.agent.MapStats;
...
public class ExploratorySimBoard extends SimBoard
{
	...
	public ExploratorySimBoard(Country [] originalCountries, BoardState boardState, SimAgent [] simAgents, CardManager cardManager)
	{
			...
			for(attackerCC = startSourceIndex; attackerCC < numberOfCountries; attackerCC++)
			{
				...
				if(attackingCountry.getOwner() == currentPlayer && attackingArmies > 1)
				{
					...
					for(Country defendingCountry : attackingCountry.getAdjoiningList())
					{
						...
						defendingArmies = defendingCountry.getArmies();
